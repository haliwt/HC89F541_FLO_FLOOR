...
void main(void)
{
	...
	{
#if 0
		SetXMotor(1,20,40,2,1,20,40,2);//����ģʽ ��back run
				    SetMotorcm(3,9000);
					RunMs=0;
					RunStep=6;
		#endif 
...
void TIMER1_Rpt(void) interrupt TIMER1_VECTOR
{
  ...
  if(t_10ms>99) //100 * 0.1ms = 10ms
  {
	...
	{
	  if(ReadPowerStatus()) //P1_7 ==1(charge batter is over) OK ��ع���оƬ��?
...
void INT8_17_Rpt() interrupt INT8_17_VECTOR 
{
	...
	else if(PINTF1&0x80)			 //�ж�INT15�жϱ�־λ--P1_7 ��س��
	{
